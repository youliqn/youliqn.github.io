...
var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_-d1c1bd12.js"
	},
	{
		type: "script",
		href: "/assets/index-329f7601.js"
	},
	{
		type: "style",
		href: "/assets/index-767762ff.css"
	}
],
	"/": [
	{
		type: "script",
		href: "/assets/index-04701af0.js"
	},
	{
		type: "script",
		href: "/assets/index-9b0cab61.js"
	},
	{
		type: "script",
		href: "/assets/index-329f7601.js"
	...
	{
		type: "style",
		href: "/assets/index-84227e3a.css"
	}
],
	"/session/:session": [
	{
		type: "script",
		href: "/assets/_session_-cacfc5fc.js"
	},
	{
		type: "script",
		href: "/assets/index-9b0cab61.js"
...
const baseURL = process.env.NO_GFW !== "false" ? defaultEnv.OPENAI_API_BASE_URL : (process.env.OPENAI_API_BASE_URL || defaultEnv.OPENAI_API_BASE_URL).replace(/^https?:\/\//, "");
const timeout = isNaN(+process.env.TIMEOUT) ? defaultEnv.TIMEOUT : +process.env.TIMEOUT;
...
async function fetchBilling(key) {
  ...
  try {
    ...
    const startDate = new Date(now.getTime() - 90 * 24 * 60 * 60 * 1e3);
...
async function genBillingsTable(billings) {
  const table = billings.sort((m, n) => m.totalGranted === 0 ? -1 : n.rate - m.rate).map((k, i) => {
    if (k.totalGranted === 0)
      return `| ${k.key.slice(0, 8)} | 不可用 | —— | —— |`;
    return `| ${k.key.slice(0, 8)} | ${k.totalAvailable.toFixed(4)}(${(k.rate * 100).toFixed(1)}%) | ${k.totalUsed.toFixed(4)} | ${k.totalGranted} |`;
  }).join("\n");
...
const channel = isNaN(+process.env.SEND_CHANNEL) ? defaultEnv.SEND_KEY : +process.env.SEND_CHANNEL;
async function GET() {
  try {
